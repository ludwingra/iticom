  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini">
        <img src="{{ asset('admin/img/logo/icono-antena.png') }}" alt="Iticom" width="50%">
      </span>
      <!-- logo for regular state and mobile devices -->
      {{-- <span class="logo-lg"><b>{{ config('app.name') }}</b></span> --}}
      <span class="logo-lg">
        <img src="{{ asset('admin/img/logo/iticom_logo_blanco.png') }}" alt="Iticom" width="50%">
      </span>
    </a>
